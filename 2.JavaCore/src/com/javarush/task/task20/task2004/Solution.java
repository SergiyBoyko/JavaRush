...
//            if (loadedObject.equals(classWithStatic)) System.out.println("Good)");
//            else {
...
//            }
    ...
    public static class ClassWithStatic {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            if (staticString != null) printWriter.println(staticString);
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            String line;
            if ((line = reader.readLine()) != null) this.staticString = line;
            if ((line = reader.readLine()) != null) this.i = Integer.parseInt(line);
            if ((line = reader.readLine()) != null) this.j = Integer.parseInt(line);
        }
