    ...
    public static void sort(List<Stock> list) {
        Collections.sort(list, new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                res = ((Integer) date2.getYear()).compareTo((Integer) date1.getYear());
                if (res != 0) return res;
                res = ((Integer) date2.getMonth()).compareTo((Integer)date1.getMonth());
                if (res != 0) return res;
                res = ((Integer) date2.getDay()).compareTo((Integer)date1.getDay());
                if (res != 0) return res;
...
//                else {
//                    Date date1 = new Date(stock1.get("date").toString());
//                    Date date2 = new Date(stock2.get("date").toString());
//                    if (date1.compareTo(date2) != 0) return date1.compareTo(date2);
//                    else {
//                        double open1 = Double.parseDouble(stock1.get("open").toString());
//                        double open2 = Double.parseDouble(stock2.get("open").toString());
//                        double last1 = Double.parseDouble(stock1.get("last").toString());
//                        double last2 = Double.parseDouble(stock2.get("last").toString());
//                        Double res1 = last1 - open1;
//                        Double res2 = last2 - open2;
